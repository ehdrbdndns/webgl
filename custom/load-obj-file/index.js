(function(){
    ...
    let objectRotateY, objectRotateX, objectScale, objectTransitionX, objectTransitionY, objectTransitionZ,
        cameraPositionX, cameraPositionY, cameraPositionZ,
        lightPositionX, lightPositionY, lightPositionZ, shininess, innerLimit, outerLimit;

    let objFileBufferInfo;
    ...
    function draw(){
       ...
       //TODO 뷰 생성
        ...
        worldMatrix = m4.scale(worldMatrix, objectScale, objectScale, objectScale);
        worldMatrix = m4.yRotate(worldMatrix, degToRad(objectRotateY));
        worldMatrix = m4.xRotate(worldMatrix, degToRad(objectRotateX));
        worldMatrix = m4.translate(worldMatrix, objectTransitionX, objectTransitionY, objectTransitionZ);
        ...
        let offset = 0;
        let count = objFileBufferInfo.vertexBuffer.length;
    ...
    function setBuffer(){
        ...
        //TODO obj 파일의 버퍼 정보 가져오기
        objFileBufferInfo = parseObjFile('https://webgl2fundamentals.org/webgl/resources/models/cube/cube.obj');
        // objFileBufferInfo = parseObjFile('./asset/dragon.obj');
        // objFileBufferInfo = parseObjFile('./asset/cube.obj');
        // objFileBufferInfo = parseObjFile('./asset/buddha.obj');
        // objFileBufferInfo = parseObjFile('./asset/bunny.obj');
        // objFileBufferInfo = parseObjFile('./asset/Mustang_13.04.2021_Compressed.obj');
        // objFileBufferInfo = parseObjFile('./asset/Sting-Sword-lowpoly.obj');
        console.log(objFileBufferInfo);
        ...
        //3. 바인딩 포인터에 복사
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(objFileBufferInfo.vertexBuffer), gl.STATIC_DRAW);
        //4. attrib 전송
        ...
        //3. 바인딩 포인터에 복사
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(objFileBufferInfo.normalBuffer), gl.STATIC_DRAW);
        //4. attrib 전송
    ...
    function changeUIDataValue(data_id, value){
        switch (data_id) {
            ...
            case "ObjectScale":
                objectScale = value;
                break;
            case "ObjectTransitionX":
                objectTransitionX = value;
                break;
            case "ObjectTransitionY":
                objectTransitionY = value;
                break;
            case "ObjectTransitionZ":
                objectTransitionZ = value;
                break;
    ...
    function setAnimationValue(e){
        ...
        e.target.parentNode.childNodes[2].innerText = "(" + value + ")";
